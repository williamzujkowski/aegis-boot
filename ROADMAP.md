...
- **#132** Last-booted real-hardware E2E test — automate the manual shakedown that closed [#109](https://github.com/aegis-boot/aegis-boot/issues/109).
...
- **v0.12.0** — `aegis-boot` operator CLI (flash/list/add) ([#124](https://github.com/aegis-boot/aegis-boot/issues/124), [#125](https://github.com/aegis-boot/aegis-boot/issues/125)); installer-vs-live warning on Confirm screen ([#131](https://github.com/aegis-boot/aegis-boot/issues/131)); post-kexec handoff banner ([#127](https://github.com/aegis-boot/aegis-boot/issues/127)); unsigned-kernel operator guidance ([#126](https://github.com/aegis-boot/aegis-boot/issues/126)); real-hardware shakedown closing the v1.0 boot-chain gate ([#109](https://github.com/aegis-boot/aegis-boot/issues/109)).
- **v0.10.1** — repo cleanup ([#77](https://github.com/aegis-boot/aegis-boot/issues/77)), branding ([#76](https://github.com/aegis-boot/aegis-boot/issues/76)), docs accuracy audit cadence ([#78](https://github.com/aegis-boot/aegis-boot/issues/78)).
