...
### Windows / UDF ISO support (real-hardware testing surfaced #214-#217)
...
Real-hardware verified: `aegis-boot add Win11_25H2_English_x64_v2.iso /media/william/AEGIS_ISOS` refuses with exit 1 + exact error text; Alpine 209 MiB proceeds normally on the same vfat stick.
